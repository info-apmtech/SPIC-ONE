...
namespace SPIC.MauiBlazorApp.Shared.FormFlow
{
		...
		public static List<FormStepModel> Steps = new()
	{
		...
		new FormStepModel { StepNo = 2, Title = "Provide detailed records of your historical agricultural partnerships and transaction volumes to establish creditworthiness.", Route = "/Experience", PreviousRoute = "/Register", NextRoute = "/AnnualSales" },
		new FormStepModel { StepNo = 3, Title = "Please provide the sales figures for the previous fiscal year for all companies.", Route = "/AnnualSales", PreviousRoute = "/Experience", NextRoute = "/Warehouse" },
		new FormStepModel { StepNo = 4, Title = "Define logistics hubs to optimize distribution networks and verify operational reach for freight subsidization.", Route = "/Warehouse", PreviousRoute = "/AnnualSales", NextRoute = "/MarketDetails" },
		new FormStepModel { StepNo = 5, Title = "Define the agricultural landscape and regional variables for your dealership.", Route = "/MarketDetails", PreviousRoute = "/Warehouse", NextRoute = "/Companies" },
		new FormStepModel { StepNo = 6, Title = "Select companies in your region to help us understand the market and provide better logistics.", Route = "/Companies", PreviousRoute = "/MarketDetails", NextRoute = "/Proprietor" },
		...
		{
			return Steps.FirstOrDefault(x => x.Route.Equals(route, StringComparison.OrdinalIgnoreCase));
		}
	}
}
