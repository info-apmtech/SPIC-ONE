...
namespace SPIC.Core.Entities
{
    ...
    public enum PagePermission
    {
        ...
        SubDealerEmployeeMaster,SDWA,SDWAAdmin,GuestHouse,GuestHouseBooking,Rooms,RoomDetails,GuestDetails,Payment, MyBookings
        SubDealerEmployeeMaster,SDWA,SDWAAdmin,LogisticsReport
