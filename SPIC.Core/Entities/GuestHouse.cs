...
public enum GuestHouseBookingStatus
{
	...
	CheckedIn = 5         // Guest checked in at the Front Office, room currently occupied
}
...
public class GuestHouseBooking
{
	...
	public int? ExtraCotQuantity { get; set; }                           // Number of extra cots / extra beds booked (updatable at check-in)
...
/// <summary>
/// An invoice / bill generated by the Front Office for a completed guest house stay.
/// The bill snapshots the booking, stay and payment details so it can be printed or
/// downloaded at any time even if the underlying booking changes.
/// </summary>
public class GuestHouseBill
{
	public int Id { get; set; }                                          // Primary key
	public string? BillNumber { get; set; }                              // Generated public bill reference (e.g. "BILL-000123")
	public int GuestHouseBookingId { get; set; }                         // FK to the completed booking
	public GuestHouseBooking? GuestHouseBooking { get; set; }            // Navigation to the completed booking
	public DateTime BillDate { get; set; } = DateTime.Now;               // When the bill was generated
	...
	public string? GuestHouseName { get; set; }                          // Guest house name snapshot
	public string? RoomNumber { get; set; }                              // Room number snapshot
	public string? RoomType { get; set; }                                // Room type snapshot
	public DateTime? CheckInAt { get; set; }                             // Actual stay check-in
	public DateTime? CheckOutAt { get; set; }                            // Actual stay check-out
	public int? NumberOfNights { get; set; }                             // Stay length in nights
	public int? NumberOfRooms { get; set; }                              // Number of rooms booked
	public int? NumberOfPersons { get; set; }                            // Number of guests
	public int? ExtraBeds { get; set; }                                  // Number of additional beds

	// Billing amounts
	public decimal Subtotal { get; set; }                                // Sum of base line amounts (before tax)
	public decimal CgstAmount { get; set; }                              // Total CGST across all lines
	public decimal SgstAmount { get; set; }                              // Total SGST across all lines
	public decimal TotalAmount { get; set; }                             // Gross total = Subtotal + CGST + SGST
	public decimal Discount { get; set; }                                // Discounted amount applied
	public decimal AdvancePayment { get; set; }                          // Advance / amount already paid
	public decimal RoundOff { get; set; }                                // Round off adjustment (+/-)
	public decimal BalanceAmount { get; set; }                           // Final payable = Total - Discount - Advance + RoundOff
	public string? Remarks { get; set; }                                 // Front Office remarks on the bill

	// Payment
	public GuestHousePaymentMethod PaymentMethod { get; set; }           // Method used to settle the bill
	public GuestHousePaymentStatus PaymentStatus { get; set; } = GuestHousePaymentStatus.Pending; // Settlement status

	// Audit
	public string? CreatedBy { get; set; }                               // User who generated the bill
	public DateTime CreatedAt { get; set; } = DateTime.Now;              // When the bill was recorded
	public string? UpdatedBy { get; set; }                               // User who last updated the bill
	public DateTime UpdatedAt { get; set; } = DateTime.Now;              // When the bill was last updated

	// Relationships
	public ICollection<GuestHouseBillLineItem> LineItems { get; set; } = new List<GuestHouseBillLineItem>(); // Billed line items
}

/// <summary>
/// A single billed line item on a Guest House invoice (room, food, additional beds, laundry, etc.).
/// Supports per-item CGST / SGST percentages so the tax is calculated per line, not hard-coded.
/// </summary>
public class GuestHouseBillLineItem
{
	public int Id { get; set; }                                          // Primary key
	public int GuestHouseBillId { get; set; }                            // FK to the parent bill
	public GuestHouseBill? GuestHouseBill { get; set; }                  // Navigation to the parent bill

	public string? Description { get; set; }                             // Line description (e.g. "AC Deluxe Room (2 nights)")
	public decimal Quantity { get; set; }                                // Quantity / No. of rooms / voucher count
	public decimal Rate { get; set; }                                    // Charge / rate per unit
	public decimal Amount { get; set; }                                  // Base amount = Quantity * Rate
	public decimal CgstPercent { get; set; }                             // CGST % applicable to this line
	public decimal SgstPercent { get; set; }                             // SGST % applicable to this line
	public decimal CgstAmount { get; set; }                              // Computed CGST amount = Amount * Cgst% / 100
	public decimal SgstAmount { get; set; }                              // Computed SGST amount = Amount * Sgst% / 100
	public decimal LineTotal { get; set; }                               // Amount + CGST + SGST for this line
